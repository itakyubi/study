...
public class GetFolderNames {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(getFolderNames2(names2)));
        System.out.println(Arrays.toString(getFolderNames2(names3)));
        System.out.println(Arrays.toString(getFolderNames2(names4)));
        System.out.println(Arrays.toString(getFolderNames2(names5)));
    }
