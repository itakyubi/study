...
public class CountBalls {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        int lowLimit2 = 5, highLimit2 = 15;
        int lowLimit3 = 19, highLimit3 = 28;

        System.out.println(countBalls(lowLimit, highLimit));
        System.out.println(countBalls(lowLimit2, highLimit2));
        System.out.println(countBalls(lowLimit3, highLimit3));
    }
