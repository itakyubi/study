...
public class EntityParser {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(entityParser(text).equals("& is an HTML entity but &ambassador; is not."));
        System.out.println(entityParser(text2));
        System.out.println(entityParser(text2).equals("and I quote: \"...\""));
        System.out.println(entityParser(text3));
        System.out.println(entityParser(text3).equals("Stay home! Practice on Leetcode :)"));
        System.out.println(entityParser(text4));
        System.out.println(entityParser(text4).equals("x > y && x < y is always false"));
        System.out.println(entityParser(text5));
        System.out.println(entityParser(text5).equals("leetcode.com/problemset/all"));
    }
    ...
    public static String entityParser(String text) {
        ...
        while (idx < text.length()) {
            ...
            if (c == '&') {
                int j = idx + 1;
                while (j < text.length() && j - idx < 6 && text.charAt(j) != ';') {
                    j++;
                }
                String tmp = text.substring(idx, Math.min(j + 1, text.length()));
