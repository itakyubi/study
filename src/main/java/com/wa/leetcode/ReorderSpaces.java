...
public class ReorderSpaces {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(reorderSpaces(text3));
        System.out.println(reorderSpaces(text4));
        System.out.println(reorderSpaces(text5));*/
        System.out.println(reorderSpaces(text6));
    }
    ...
    private static String reorderSpaces(String text) {
        ...
        int interval = words.size() == 1 ? 0 : spaceCount / (words.size() - 1);
        StringBuilder intervalStr = new StringBuilder();
        for (int i = 0; i < interval; i++) {
            intervalStr.append(" ");
        }

        int end = words.size() == 1 ? spaceCount : spaceCount % (words.size() - 1);
